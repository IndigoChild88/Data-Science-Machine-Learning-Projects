...
from util import init_weight, get_Lyrics, get_wikipedia_data
...
class SimpleRNN:
    ...
    def fit(self, X, epochs=100, show_fig=False):
        N = len(X)
        D = self.D
        M = self.M
        V = self.V
    ...
    def generate(self, pi, word2idx):
        ...
        # Using the START symbol will always yield the same first word!
