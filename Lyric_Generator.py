# -*- coding: utf-8 -*-
"""
Created on Sat Dec 29 00:06:34 2018
...
class SimpleRNN:
    ...
    def fit(self, X, learning_rate=10e-1, mu=0.99, reg=1.0, activation=T.tanh,epochs=500, show_fig=False):
        ...
        self.predict_op = theano.fuction(inputs=[thX], outputs=prediction)
        self.train_op = theano.fucntion(
                 iputs=[thX, thY],
        ...
        py_x = y[:, 0, :]
        prediction = T.argmax(py_x, axis=1)
        self.predict_op=theano.fuction(
                 input=[thX], outputs=prediction,
